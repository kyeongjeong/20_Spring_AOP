...
/*
	...
	# execution 명시자 
	   ...
	   - execution(수식어패턴 리턴타입패턴 패키지.클래스.메서드이름패턴(파라미터패턴)) 
...
public class Advice {
	...
	public void getWorkingTime(ProceedingJoinPoint pjp) throws Throwable {
	...
	// 타겟팅 메서드가 성공적으로 실행 된 후
	@AfterReturning("execution(public * getInfo(..))")
	public void getInfo(JoinPoint jp) { // JoinPoint를 통하여 메서드의 파라메타를 전달받을 수 있다.
