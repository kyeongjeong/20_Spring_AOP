...
/* 
	...
	# Logger객체 생성 (private) static Logger logger = LoggerFactory.getLogger(클래스이름.class);
		...
		import org.slf4j.LoggerFactory;
	 	...
	 	- log4j로깅방식을 통해서 여러개발자가 협업을 하는 경우 로깅방법을 통일할 수 있다.
	 	- log4j를 이용하여 로그의 레벨별로 체계적인 로그관리가 가능하다.
...
public class LoggerAdvice {
	...
	public void getMethodExecutionTime(ProceedingJoinPoint pjp) throws Throwable {
